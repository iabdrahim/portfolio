  ...
  return (
    <Container className="max-w-4xl" fullWidth={true}>
      <div className="flex max-md:mt-6 justify-between gap-4 w-full mb-6">
        <h1 className="text-7xl font-black max-md:text-[2.4rem]">About Me</h1>
        <img
      ...
      <div className="flex justify-between">
        <p className="text-lg max-sm:text-base mb-8 text-gray-900 dark:text-gray-200">
          Most of the things you (maybe) want to know about me.
          <br />
          <br />
          I&apos;m abdrahim! Let me tell you a little bit about myself. I&apos;m
          a 19 years old student belonging to the Homo Sapiens species, a
          brother, a son, a friend, a self taught web developer and programmer.
          I was already creating amazing projects using Python back in 11th
          grade, and started frontend development soon after. So far, I&apos;ve
          mastered many languages, including TypeScript, Python, and C++.
          <br />
          <br />
          Things I do other than dev and programming? Not much, but I enjoy
